<?php
/**
 * Immersive Cinema mobile property actions.
 *
 * Override this template by copying it to yourtheme/propertyhive/template-set/detail/immersive-cinema-detail/mobile-cta.php
 *
