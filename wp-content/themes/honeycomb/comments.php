...
<section id="comments" class="comments-area" aria-label="Post Comments">
	...
	if ( have_comments() ) : ?>
		...
		<nav id="comment-nav-above" class="comment-navigation" role="navigation" aria-label="Comment Navigation Above">
			<span class="screen-reader-text"><?php esc_html_e( 'Comment navigation', 'honeycomb' ); ?></span>
			<div class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 'honeycomb' ) ); ?></div>
			<div class="nav-next"><?php next_comments_link( __( 'Newer Comments &rarr;', 'honeycomb' ) ); ?></div>
	...
	if ( ! comments_open() && '0' != get_comments_number() && post_type_supports( get_post_type(), 'comments' ) ) : ?>
		<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'honeycomb' ); ?></p>
	<?php endif;

	$args = apply_filters( 'honeycomb_comment_form_args', array(
