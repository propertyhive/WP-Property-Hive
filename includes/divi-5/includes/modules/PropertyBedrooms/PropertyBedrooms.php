...
class PropertyBedrooms extends PropertyMetaModule implements DependencyInterface {
    const MODULE_DIR = 'property-bedrooms';
    const MODULE_CLASS_NAME = 'propertyhive_divi5_property_bedrooms';
