...
class PH_Template_Set {
	...
	public static function sanitize_template_set_settings( $raw_settings, $current_settings = array(), $activate = false ) {
		...
		if ( 'compact-list-search-results' === $search_template ) {
			$search_layout = 'list';
		} elseif ( ! isset( self::get_search_layouts()[ $search_layout ] ) ) {
			$search_layout = '';
		}
		...
		if ( ! isset( self::get_search_card_sizes()[ $search_card_size ] ) ) {
		...
		echo '<aside class="ph-template-editor ph-template-editor-' . esc_attr( sanitize_html_class( $context ) ) . '" data-ph-template-editor data-ph-template-editor-context="' . esc_attr( $context ) . '" aria-label="' . esc_attr__( 'Template editor', 'propertyhive' ) . '">';
			echo '<form class="ph-template-editor-form" data-ph-template-editor-form>';
				...
				if ( 'search' === $context ) {
					...
					self::render_template_editor_select( 'template_set_search_template', __( 'Search template', 'propertyhive' ), self::get_search_templates(), self::get_search_template(), self::get_template_editor_preview_urls( self::get_search_templates() ) );
				} else {
	...
	private static function get_search_view() {
		...
		if ( isset( self::get_search_layouts()[ $view ] ) ) {
			return $view;
		}
