<?php
/**
 * Bricks Builder Property Reception Rooms Widget.
 *
 * @since 1.0.0
 */
...
class Bricks_Builder_Property_Reception_Rooms_Widget extends \Bricks\Element {

	// Element properties
	public $category     = 'propertyhive';
  	public $name         = 'bricks-builder-property-reception-rooms';
  	public $icon         = 'fas fa-couch';

	public function get_label() 
	{
	    return esc_html__( 'Reception Rooms', 'propertyhive' );
	}
