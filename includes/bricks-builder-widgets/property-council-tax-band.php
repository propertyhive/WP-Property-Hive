<?php
/**
 * Bricks Builder Property Council Tax Band Widget.
 *
 * @since 1.0.0
 */
...
class Bricks_Builder_Property_Council_Tax_Band_Widget extends \Bricks\Element {

	// Element properties
	public $category     = 'propertyhive';
  	public $name         = 'bricks-builder-property-council-tax-band';
  	public $icon         = 'fas fa-tag';

	public function get_label() 
	{
	    return esc_html__( 'Council Tax Band', 'propertyhive' );
	}
	...
	public function set_controls() 
	{
	    ...
	    $this->controls['before'] = [
	      	...
	      	'type' => 'text',
	      	'default' => __( 'Council Tax Band:', 'propertyhive' ),
	    ];
