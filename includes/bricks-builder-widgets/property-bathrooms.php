<?php
/**
 * Bricks Builder Property Bathrooms Widget.
 *
 * @since 1.0.0
 */
...
class Bricks_Builder_Property_Bathrooms_Widget extends \Bricks\Element {

	// Element properties
	public $category     = 'propertyhive';
  	public $name         = 'bricks-builder-property-bathrooms';
  	public $icon         = 'fas fa-bath';

	public function get_label() 
	{
	    return esc_html__( 'Bathrooms', 'propertyhive' );
	}
