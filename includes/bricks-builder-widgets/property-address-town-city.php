<?php
/**
 * Bricks Builder Property Address Town/City Widget.
 *
 * @since 1.0.0
 */
...
class Bricks_Builder_Property_Address_Town_City_Widget extends \Bricks\Element {

	// Element properties
	public $category     = 'propertyhive';
  	public $name         = 'bricks-builder-property-address-town-city';
  	public $icon         = 'fas fa-house';

	public function get_label() 
	{
	    return esc_html__( 'Address Town/City', 'propertyhive' );
	}
