<?php
/**
 * Bricks Builder Property Price Qualifier Widget.
 *
 * @since 1.0.0
 */
...
class Bricks_Builder_Property_Price_Qualifier_Widget extends \Bricks\Element {

	// Element properties
	public $category     = 'propertyhive';
  	public $name         = 'bricks-builder-property-price-qualifier';
  	public $icon         = 'fas fa-tag';

	public function get_label() 
	{
	    return esc_html__( 'Price Qualifier', 'propertyhive' );
	}
