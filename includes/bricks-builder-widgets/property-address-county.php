<?php
/**
 * Bricks Builder Property Address County Widget.
 *
 * @since 1.0.0
 */
...
class Bricks_Builder_Property_Address_County_Widget extends \Bricks\Element {

	// Element properties
	public $category     = 'propertyhive';
  	public $name         = 'bricks-builder-property-address-county';
  	public $icon         = 'fas fa-house';

	public function get_label() 
	{
	    return esc_html__( 'Address County', 'propertyhive' );
	}
