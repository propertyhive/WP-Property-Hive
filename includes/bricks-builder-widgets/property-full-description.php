<?php
/**
 * Bricks Builder Property Full Description Widget.
 *
 * @since 1.0.0
 */
...
class Bricks_Builder_Property_Full_Description_Widget extends \Bricks\Element {

	// Element properties
	public $category     = 'propertyhive';
  	public $name         = 'bricks-builder-property-full-description';
  	public $icon         = 'fas fa-paragraph';

	public function get_label() 
	{
	    return esc_html__( 'Full Description', 'propertyhive' );
	}
