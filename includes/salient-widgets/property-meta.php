...
class Salient_Property_Meta_Widget {
	...
	public function custom_wpbakery_element_icon()
	{
		echo '<style type="text/css">
			.wpb_salient_property_meta .vc_element-icon:before,
			a[data-tag="salient_property_meta"] .vc_element-icon:before {
	...
	public function custom_wpbakery_element()
	{
		...
		vc_map( array(
      		"name" => __( 'Meta', 'propertyhive' ),
      		"base" => "salient_property_meta",
      		"class" => "",
...
new Salient_Property_Meta_Widget();