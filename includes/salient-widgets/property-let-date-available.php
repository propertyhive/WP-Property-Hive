<?php
/**
 * Salient Property Let Date Available Widget.
 *
 * @since 1.0.0
 */
...
class Salient_Property_Let_Date_Available_Widget {
	...
	public function custom_wpbakery_element_icon()
	{
		echo '<style type="text/css">
			.wpb_salient_property_let_date_available .vc_element-icon:before,
			a[data-tag="salient_property_let_date_available"] .vc_element-icon:before {
	...
	public function custom_wpbakery_element()
	{
		...
		vc_map( array(
      		"name" => __( 'Let Date Available', 'propertyhive' ),
      		"base" => "salient_property_let_date_available",
      		"class" => "",
...
new Salient_Property_Let_Date_Available_Widget();