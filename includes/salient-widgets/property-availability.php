<?php
/**
 * Salient Property Availability Widget.
 *
 * @since 1.0.0
 */
...
class Salient_Property_Availability_Widget {
	...
	public function custom_wpbakery_element_icon()
	{
		echo '<style type="text/css">
			.wpb_salient_property_availability .vc_element-icon:before,
			a[data-tag="salient_property_availability"] .vc_element-icon:before {
	...
	public function custom_wpbakery_element()
	{
		...
		vc_map( array(
      		"name" => __( 'Availability', 'propertyhive' ),
      		"base" => "salient_property_availability",
      		"class" => "",
...
new Salient_Property_Availability_Widget();