<?php
/**
 * Salient Property Address Postcode Widget.
 *
 * @since 1.0.0
 */
...
class Salient_Property_Address_Postcode_Widget {
	...
	public function custom_wpbakery_element_icon()
	{
		echo '<style type="text/css">
			.wpb_salient_property_address_postcode .vc_element-icon:before,
			a[data-tag="salient_property_address_postcode"] .vc_element-icon:before {
	...
	public function custom_wpbakery_element()
	{
		...
		vc_map( array(
      		"name" => __( 'Address Postcode', 'propertyhive' ),
      		"base" => "salient_property_address_postcode",
      		"class" => "",
...
new Salient_Property_Address_Postcode_Widget();