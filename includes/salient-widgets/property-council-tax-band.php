<?php
/**
 * Salient Property Council Tax Band Widget.
 *
 * @since 1.0.0
 */
...
class Salient_Property_Council_Tax_Band_Widget {
	...
	public function custom_wpbakery_element_icon()
	{
		echo '<style type="text/css">
			.wpb_salient_property_council_tax_band .vc_element-icon:before,
			a[data-tag="salient_property_council_tax_band"] .vc_element-icon:before {
	...
	public function custom_wpbakery_element()
	{
		...
		vc_map( array(
      		"name" => __( 'Council Tax Band', 'propertyhive' ),
      		"base" => "salient_property_council_tax_band",
      		"class" => "",
...
new Salient_Property_Council_Tax_Band_Widget();