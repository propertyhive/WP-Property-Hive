<?php
/**
 * Salient Property Price Qualifier Widget.
 *
 * @since 1.0.0
 */
...
class Salient_Property_Price_Qualifier_Widget {
	...
	public function custom_wpbakery_element_icon()
	{
		echo '<style type="text/css">
			.wpb_salient_property_price_qualifier .vc_element-icon:before,
			a[data-tag="salient_property_price_qualifier"] .vc_element-icon:before {
	...
	public function custom_wpbakery_element()
	{
		...
		vc_map( array(
      		"name" => __( 'Price Qualifier', 'propertyhive' ),
      		"base" => "salient_property_price_qualifier",
      		"class" => "",
...
new Salient_Property_Price_Qualifier_Widget();