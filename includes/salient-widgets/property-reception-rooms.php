<?php
/**
 * Salient Property Reception Rooms Widget.
 *
 * @since 1.0.0
 */
...
class Salient_Property_Reception_Rooms_Widget {
	...
	public function custom_wpbakery_element_icon()
	{
		echo '<style type="text/css">
			.wpb_salient_property_reception_rooms .vc_element-icon:before,
			a[data-tag="salient_property_reception_rooms"] .vc_element-icon:before {
	...
	public function custom_wpbakery_element()
	{
		...
		vc_map( array(
      		"name" => __( 'Reception Rooms', 'propertyhive' ),
      		"base" => "salient_property_reception_rooms",
      		"class" => "",
...
new Salient_Property_Reception_Rooms_Widget();