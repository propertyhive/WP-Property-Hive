<?php
/**
 * Salient Property Bedrooms Widget.
 *
 * @since 1.0.0
 */
...
class Salient_Property_Bedrooms_Widget {
	...
	public function custom_wpbakery_element_icon()
	{
		echo '<style type="text/css">
			.wpb_salient_property_bedrooms .vc_element-icon:before,
			a[data-tag="salient_property_bedrooms"] .vc_element-icon:before {
	...
	public function custom_wpbakery_element()
	{
		...
		vc_map( array(
      		"name" => __( 'Bedrooms', 'propertyhive' ),
      		"base" => "salient_property_bedrooms",
      		"class" => "",
...
new Salient_Property_Bedrooms_Widget();