...
class Salient_Property_Type_Widget {
	...
	public function custom_wpbakery_element_icon()
	{
		echo '<style type="text/css">
			.wpb_salient_property_type .vc_element-icon:before,
			a[data-tag="salient_property_type"] .vc_element-icon:before {
	...
	public function custom_wpbakery_element()
	{
		...
		vc_map( array(
      		"name" => __( 'Property Type', 'propertyhive' ),
      		"base" => "salient_property_type",
      		"class" => "",
...
new Salient_Property_Type_Widget();