<?php
/**
 * Salient Property Address County Widget.
 *
 * @since 1.0.0
 */
...
class Salient_Property_Address_County_Widget {
	...
	public function custom_wpbakery_element_icon()
	{
		echo '<style type="text/css">
			.wpb_salient_property_address_county .vc_element-icon:before,
			a[data-tag="salient_property_address_county"] .vc_element-icon:before {
	...
	public function custom_wpbakery_element()
	{
		...
		vc_map( array(
      		"name" => __( 'Address County', 'propertyhive' ),
      		"base" => "salient_property_address_county",
      		"class" => "",
...
new Salient_Property_Address_County_Widget();