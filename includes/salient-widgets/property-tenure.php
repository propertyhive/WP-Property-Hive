<?php
/**
 * Salient Property Tenure Widget.
 *
 * @since 1.0.0
 */
...
class Salient_Property_Tenure_Widget {
	...
	public function custom_wpbakery_element_icon()
	{
		echo '<style type="text/css">
			.wpb_salient_property_tenure .vc_element-icon:before,
			a[data-tag="salient_property_tenure"] .vc_element-icon:before {
	...
	public function custom_wpbakery_element()
	{
		...
		vc_map( array(
      		"name" => __( 'Tenure', 'propertyhive' ),
      		"base" => "salient_property_tenure",
      		"class" => "",
...
new Salient_Property_Tenure_Widget();