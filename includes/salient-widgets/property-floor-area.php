<?php
/**
 * Salient Property Floor Area Widget.
 *
 * @since 1.0.0
 */
...
class Salient_Property_Floor_Area_Widget {
	...
	public function custom_wpbakery_element_icon()
	{
		echo '<style type="text/css">
			.wpb_salient_property_floor_area .vc_element-icon:before,
			a[data-tag="salient_property_floor_area"] .vc_element-icon:before {
	...
	public function custom_wpbakery_element()
	{
		...
		vc_map( array(
      		"name" => __( 'Floor Area', 'propertyhive' ),
      		"base" => "salient_property_floor_area ",
      		"class" => "",
...
new Salient_Property_Floor_Area_Widget();