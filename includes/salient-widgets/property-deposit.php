<?php
/**
 * Salient Property Deposit Widget.
 *
 * @since 1.0.0
 */
...
class Salient_Property_Deposit_Widget {
	...
	public function custom_wpbakery_element_icon()
	{
		echo '<style type="text/css">
			.wpb_salient_property_deposit .vc_element-icon:before,
			a[data-tag="salient_property_deposit"] .vc_element-icon:before {
...
new Salient_Property_Deposit_Widget();