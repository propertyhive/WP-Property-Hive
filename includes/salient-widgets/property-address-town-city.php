<?php
/**
 * Salient Property Address Town/City Widget.
 *
 * @since 1.0.0
 */
...
class Salient_Property_Address_Town_City_Widget {
    ...
    public function custom_wpbakery_element_icon()
    {
        echo '<style type="text/css">
            .wpb_salient_property_address_town_city .vc_element-icon:before,
            a[data-tag="salient_property_address_town_city"] .vc_element-icon:before {
    ...
    public function custom_wpbakery_element()
    {
        ...
        vc_map( array(
            "name" => __( 'Address Town/City', 'propertyhive' ),
            "base" => "salient_property_address_town_city",
            "class" => "",
...
new Salient_Property_Address_Town_City_Widget();