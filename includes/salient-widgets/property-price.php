...
class Salient_Property_Price_Widget {
	...
	public function custom_wpbakery_element_icon()
	{
		echo '<style type="text/css">
			.wpb_salient_property_price .vc_element-icon:before,
			a[data-tag="salient_property_price"] .vc_element-icon:before {
	...
	public function custom_wpbakery_element()
	{
		...
		vc_map( array(
      		"name" => __( 'Price', 'propertyhive' ),
      		"base" => "salient_property_price",
      		"class" => "",
...
new Salient_Property_Price_Widget();