<?php
/**
 * Salient Property Full Description Widget.
 *
 * @since 1.0.0
 */
...
class Salient_Property_Full_Description_Widget {
	...
	public function custom_wpbakery_element_icon()
	{
		echo '<style type="text/css">
			.wpb_salient_property_full_description .vc_element-icon:before,
			a[data-tag="salient_property_full_description"] .vc_element-icon:before {
	...
	public function custom_wpbakery_element()
	{
		...
		vc_map( array(
      		"name" => __( 'Full Description', 'propertyhive' ),
      		"base" => "salient_property_full_description",
      		"class" => "",
...
new Salient_Property_Full_Description_Widget();