<?php
/**
 * Salient Property Bathrooms Widget.
 *
 * @since 1.0.0
 */
...
class Salient_Property_Bathrooms_Widget {
	...
	public function custom_wpbakery_element_icon()
	{
		echo '<style type="text/css">
			.wpb_salient_property_bathrooms .vc_element-icon:before,
			a[data-tag="salient_property_bathrooms"] .vc_element-icon:before {
	...
	public function custom_wpbakery_element()
	{
		...
		vc_map( array(
      		"name" => __( 'Bathrooms', 'propertyhive' ),
      		"base" => "salient_property_bathrooms",
      		"class" => "",
...
new Salient_Property_Bathrooms_Widget();