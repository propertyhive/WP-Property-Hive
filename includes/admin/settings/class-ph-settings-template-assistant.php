...
class PH_Settings_Template_Assistant extends PH_Settings_Page {
	...
	public function get_settings() {
        ...
        <style>
            ...
            .ph-ta-merge-grid > div { display:flex; gap:20px; background:#FFF; padding:25px; border:1px solid #AAA }
            .ph-ta-merge-grid > div .ph-grid-image { flex:0 0 50px; }
            .ph-ta-merge-grid > div .ph-grid-image-bg { background:#fbfcd4; border:1px solid #ffcd00; padding:10px; border-radius:7px; }
            .ph-ta-merge-grid > div .ph-grid-image img { max-width:40px; height:40px; display:block }
            .ph-ta-merge-grid > div .feature-card-content { flex:1; min-width:0; }
            .ph-ta-merge-grid > div h3 { margin-top:0; margin-bottom:0.8em }

            @media (max-width:1370px) {

                .ph-ta-merge-grid { grid-template-columns:repeat(2, 1fr); }
