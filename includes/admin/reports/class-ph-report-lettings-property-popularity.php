...
/**
 * PH_Report_Lettings_Property_Popularity
 *
 * @author      PropertyHive
 * @category    Admin
 ...
 * @version     1.0.0
 */
// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedClassFound -- Legacy public global class PH_Report_Lettings_Property_Popularity; preserving the existing PH_* class name is required for plugin and extension compatibility.
class PH_Report_Lettings_Property_Popularity extends PH_Admin_Report {
...
<div class="chart-tabs">
	<ul>
		<li<?php if ( $duration == 0 ) { echo ' class="active"'; } ?>><a href="admin.php?page=ph-reports&tab=properties&report=lettings_property_popularity&duration=1">Yesterday</a></li>
		<li<?php if ( $duration == 6 ) { echo ' class="active"'; } ?>><a href="admin.php?page=ph-reports&tab=properties&report=lettings_property_popularity&duration=7">Last 7 Days</a></li>
		<li<?php if ( $duration == 29 ) { echo ' class="active"'; } ?>><a href="admin.php?page=ph-reports&tab=properties&report=lettings_property_popularity&duration=30">Last 30 Days</a></li>
	</ul>
</div>
