...
class PH_Admin_Menus {
	...
	public function admin_menu() {
        ...
        //add_submenu_page( 'propertyhive', __( 'Applicants', 'propertyhive' ), __( 'Properties', 'propertyhive' ), 'manage_propertyhive', 'edit.php?post_type=property'/*, array( $this, 'attributes_page' )*/ );
