 ...
 */
// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedClassFound -- Legacy public global class PH_Meta_Box_Contact_Notes; preserving the existing PH_* class name is required for plugin and extension compatibility.
    ...
    public static function output( $post ) {
        ...
        echo '<ul class="subsubsub notes-filter" style="float:none; padding-left:10px;">';
            ...
            foreach ( $notes_filters as $class => $label )
            {
                ...
                // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Built-in labels are escaped before the trusted PHP propertyhive_notes_filters and propertyhive_contact_notes_filters hooks, which intentionally permit extension HTML.
                echo $label;
                echo '</a>';
