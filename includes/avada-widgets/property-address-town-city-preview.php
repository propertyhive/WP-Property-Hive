...
?>
<script type="text/template" id="fusion-builder-block-module-property-address-town-city-preview-template">
	...
	<div class="fusion-module-property-address-town-city-preview" style="{{{ styleTag }}}">
		{{{iconHtml}}}{{{beforeLabel}}}Address Town/City{{{afterLabel}}}
	</div>
