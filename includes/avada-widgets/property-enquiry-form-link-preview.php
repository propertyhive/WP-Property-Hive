...
?>
<script type="text/template" id="fusion-builder-block-module-property-enquiry-form-link-preview-template">
	...
	<div class="fusion-module-property-enquiry-form-link-preview">
		<a href="#" style="{{{ styleTag }}}">Make Enquiry</a>
	</div>
