...
?>
<script type="text/template" id="fusion-builder-block-module-property-bathrooms-preview-template">
	...
	<div class="fusion-module-property-bathrooms-preview" style="{{{ styleTag }}}">
		{{{iconHtml}}}{{{beforeLabel}}}1{{{afterLabel}}}
	</div>
