...
?>
<script type="text/template" id="fusion-builder-block-module-property-bedrooms-preview-template">
	...
	<div class="fusion-module-property-bedrooms-preview" style="{{{ styleTag }}}">
		{{{iconHtml}}}{{{beforeLabel}}}4{{{afterLabel}}}
	</div>
