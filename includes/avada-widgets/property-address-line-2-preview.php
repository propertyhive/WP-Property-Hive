...
?>
<script type="text/template" id="fusion-builder-block-module-property-address-line-2-preview-template">
	...
	<div class="fusion-module-property-address-line-2-preview" style="{{{ styleTag }}}">
		{{{iconHtml}}}{{{beforeLabel}}}Address Line 2{{{afterLabel}}}
	</div>
