...
add_shortcode( 'avada_property_address_county', function( $atts ) {
    $atts = shortcode_atts( array(
        'content_align'    => 'left',
        'fusion_font_family_address_county_font' => '',
        'fusion_font_variant_address_county_font' => '',
        'font_size'  => '',
        'letter_spacing'  => '',
        'text_transform'  => '',
        'line_height'  => '',
    ...
    $style = Fusion_Builder_Element_Helper::get_font_styling( $atts, 'address_county_font' );
    ...
    echo '<div ' . FusionBuilder::attributes( 'property-address-county-shortcode' ) . '>';  // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
    echo '
