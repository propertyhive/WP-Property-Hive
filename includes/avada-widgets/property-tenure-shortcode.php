...
add_shortcode( 'avada_property_tenure', function( $atts ) {
    $atts = shortcode_atts( array(
        'content_align'    => 'left',
        'fusion_font_family_tenure_font' => '',
        'fusion_font_variant_tenure_font' => '',
        'font_size'  => '',
        'letter_spacing'  => '',
        'text_transform'  => '',
        'line_height'  => '',
    ...
    $style = Fusion_Builder_Element_Helper::get_font_styling( $atts, 'tenure_font' );
    ...
    echo '<div ' . FusionBuilder::attributes( 'property-tenure-shortcode' ) . '>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
    echo '
