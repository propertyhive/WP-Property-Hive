...
?>
<script type="text/template" id="fusion-builder-block-module-property-address-full-preview-template">
	...
	<div class="fusion-module-property-address-full-preview" style="{{{ styleTag }}}">
		{{{iconHtml}}}{{{beforeLabel}}}Full Address{{{afterLabel}}}
	</div>
