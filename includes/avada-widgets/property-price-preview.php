...
?>
<script type="text/template" id="fusion-builder-block-module-property-price-preview-template">
	...
	<#
		...
		if ( params.show_price_qualifier && params.show_price_qualifier != 'on' )
		{
			// dont need to do anything here as no price qualifier in preview
		}
	#>

	<div class="fusion-module-property-price-preview" style="{{{ styleTag }}}">
		&pound;450,000
	</div>
