...
?>
<script type="text/template" id="fusion-builder-block-module-property-let-available-date-preview-template">
	...
	<div class="fusion-module-property-let-available-date-preview" style="{{{ styleTag }}}">
		{{{iconHtml}}}{{{beforeLabel}}}24th February 2025{{{afterLabel}}}
	</div>
