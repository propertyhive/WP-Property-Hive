...
add_shortcode( 'avada_property_address_name_number', function( $atts ) {
    $atts = shortcode_atts( array(
        'content_align'    => 'left',
        'fusion_font_family_address_name_number_font' => '',
        'fusion_font_variant_address_name_number_font' => '',
        'font_size'  => '',
        'letter_spacing'  => '',
        'text_transform'  => '',
        'line_height'  => '',
    ...
    $style = Fusion_Builder_Element_Helper::get_font_styling( $atts, 'address_name_number_font' );
    ...
    echo '<div ' . FusionBuilder::attributes( 'property-address-name-number-shortcode' ) . '>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
    echo '
