...
?>
<script type="text/template" id="fusion-builder-block-module-property-reference-number-preview-template">
	...
	<div class="fusion-module-property-reference-number-preview" style="{{{ styleTag }}}">
		{{{iconHtml}}}{{{beforeLabel}}}001-ABC{{{afterLabel}}}
	</div>
