...
?>
<script type="text/template" id="fusion-builder-block-module-property-deposit-preview-template">
	...
	<div class="fusion-module-property-deposit-preview" style="{{{ styleTag }}}">
		{{{iconHtml}}}{{{beforeLabel}}}£500{{{afterLabel}}}
	</div>
