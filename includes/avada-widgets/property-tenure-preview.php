...
?>
<script type="text/template" id="fusion-builder-block-module-property-tenure-preview-template">
	...
	<div class="fusion-module-property-tenure-preview" style="{{{ styleTag }}}">
		{{{iconHtml}}}{{{beforeLabel}}}Freehold{{{afterLabel}}}
	</div>
