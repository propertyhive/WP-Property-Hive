...
?>
<script type="text/template" id="fusion-builder-block-module-property-council-tax-preview-template">
	...
	<div class="fusion-module-property-council-tax-preview" style="{{{ styleTag }}}">
		{{{iconHtml}}}{{{beforeLabel}}}B{{{afterLabel}}}
	</div>
