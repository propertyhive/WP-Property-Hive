...
add_shortcode( 'avada_property_reception_rooms', function( $atts ) {
    $atts = shortcode_atts( array(
        'content_align'    => 'left',
        'fusion_font_family_reception_rooms_font' => '',
        'fusion_font_variant_reception_rooms_font' => '',
        'font_size'  => '',
        'letter_spacing'  => '',
        'text_transform'  => '',
        'line_height'  => '',
    ...
    $style = Fusion_Builder_Element_Helper::get_font_styling( $atts, 'reception_rooms_font' );
    ...
    echo '<div ' . FusionBuilder::attributes( 'property-reception_rooms-shortcode' ) . '>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
    echo '
