...
?>
<script type="text/template" id="fusion-builder-block-module-property-address-county-preview-template">
	...
	<div class="fusion-module-property-address-county-preview" style="{{{ styleTag }}}">
		{{{iconHtml}}}{{{beforeLabel}}}Address County{{{afterLabel}}}
	</div>
