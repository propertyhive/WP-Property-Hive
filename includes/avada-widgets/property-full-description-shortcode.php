...
add_shortcode( 'avada_property_full_description', function( $atts ) {
    $atts = shortcode_atts( array(
        'content_align'    => 'left',
        'fusion_font_family_full_description_font' => '',
        'fusion_font_variant_full_description_font' => '',
        'font_size'  => '',
        'letter_spacing'  => '',
        'text_transform'  => '',
        'line_height'  => '',
    ...
    $style = Fusion_Builder_Element_Helper::get_font_styling( $atts, 'full_description_font' );
...
?>
<style type="text/css">
.full-description h4 { display:none; }
</style>
<?php
    }

    echo '<div ' . FusionBuilder::attributes( 'property-full-description-shortcode' ) . '>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
    echo '
