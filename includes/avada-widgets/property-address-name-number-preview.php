...
?>
<script type="text/template" id="fusion-builder-block-module-property-address-name-number-preview-template">
	...
	<div class="fusion-module-property-address-name-number-preview" style="{{{ styleTag }}}">
		{{{iconHtml}}}{{{beforeLabel}}}Address Name/Number{{{afterLabel}}}
	</div>
