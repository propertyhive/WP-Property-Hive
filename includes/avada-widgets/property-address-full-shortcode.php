...
add_shortcode( 'avada_property_address_full', function( $atts ) {
    $atts = shortcode_atts( array(
        'content_align'    => 'left',
        'fusion_font_family_address_full_font' => '',
        'fusion_font_variant_address_full_font' => '',
        'font_size'  => '',
        'letter_spacing'  => '',
        'text_transform'  => '',
        'line_height'  => '',
    ...
    if ( $property->get_formatted_full_address() == '' )
    {
        return '';
    }

    $style = Fusion_Builder_Element_Helper::get_font_styling( $atts, 'address_full_font' );
    ...
    echo '<div ' . FusionBuilder::attributes( 'property-address-full-shortcode' ) . '>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
    echo '
