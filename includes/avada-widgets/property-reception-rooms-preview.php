...
?>
<script type="text/template" id="fusion-builder-block-module-property-reception-rooms-preview-template">
	...
	<div class="fusion-module-property-reception-rooms-preview" style="{{{ styleTag }}}">
		{{{iconHtml}}}{{{beforeLabel}}}2{{{afterLabel}}}
	</div>
