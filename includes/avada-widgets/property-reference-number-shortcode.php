...
add_shortcode( 'avada_property_reference_number', function( $atts ) {
    $atts = shortcode_atts( array(
        'content_align'    => 'left',
        'fusion_font_family_reference_number_font' => '',
        'fusion_font_variant_reference_number_font' => '',
        'font_size'  => '',
        'letter_spacing'  => '',
        'text_transform'  => '',
        'line_height'  => '',
    ...
    $style = Fusion_Builder_Element_Helper::get_font_styling( $atts, 'reference_number_font' );
