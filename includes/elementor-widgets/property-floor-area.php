<?php
/**
 * Elementor Property Floor Area Widget.
 *
 * @since 1.0.0
 */
class Elementor_Property_Floor_Area_Widget extends \Elementor\Widget_Base {

	public function get_name() {
		return 'property-floor-area';
	}

	public function get_title() {
		return __( 'Floor Area', 'propertyhive' );
	}
	...
	public function get_keywords() {
		return [ 'property hive', 'propertyhive', 'property', 'floor area', 'area' ];
	}
	...
	protected function _register_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .elementor-widget-floor-area',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-widget-floor-area' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'toggle' => true,
				'selectors' => [
					'{{WRAPPER}} .elementor-widget-floor-area' => 'text-align: {{VALUE}}',
				],
			]
		);
	...
	protected function render() {
		...
		{
	        echo '<div class="elementor-widget-floor-area">';
