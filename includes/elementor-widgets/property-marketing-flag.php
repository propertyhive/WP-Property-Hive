<?php
/**
 * Elementor Property Marketing Flag Widget.
 *
 * @since 1.0.0
 */
class Elementor_Property_Marketing_Flag_Widget extends \Elementor\Widget_Base {

	public function get_name() {
		return 'property-marketing-flag';
	}

	public function get_title() {
		return __( 'Marketing Flag', 'propertyhive' );
	}
	...
	public function get_keywords() {
		return [ 'property hive', 'propertyhive', 'property', 'marketing flag', 'status' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'toggle' => true,
				'selectors' => [
					'{{WRAPPER}} .elementor-widget-marketing-flag' => 'text-align: {{VALUE}}',
				],
			]
		);
