<?php
/**
 * Elementor Property Bathrooms Widget.
 *
 * @since 1.0.0
 */
class Elementor_Property_Bathrooms_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Bathrooms', 'propertyhive' );
	}
	...
	public function get_keywords() {
		return [ 'property hive', 'propertyhive', 'property', 'bathroom', 'room' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'Bathrooms', 'propertyhive' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'toggle' => true,
				'selectors' => [
					'{{WRAPPER}} .elementor-widget-bathrooms' => 'text-align: {{VALUE}}',
				],
			]
		);
	...
	protected function render() {
		...
		{
	        echo '<div class="elementor-widget-bathrooms">';
